...
/* VGA reuses the QVGA table's proven color/ISP baseline and only changes the
 * subsample ratio to 1:1. The older standalone VGA table used different color
 * and AWB-related registers; on this board it can produce a red-dominated
 * 640x480 image while the 320x240 subsample mode remains correct.
 */
#define init_reglist_DVP_8bit_640x480_16fps \
    init_reglist_DVP_8bit_320x240_20fps_subsample, \
    {0xfe, 0x01}, \
    {0x54, 0x11}, /* 1:1 subsample ratio for full VGA */\
    {0x56, 0x00}, \
    {0x57, 0x00}, \
    {0x58, 0x00}, \
    {0x59, 0x00}, \
